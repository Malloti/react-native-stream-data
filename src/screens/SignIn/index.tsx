        ...
        <LoginInfo>
          ...
          { <SignInButton {...signInButtonProps}>
            <SignInButtonIcon>
              {
                isLoggingIn 
                ? <ActivityIndicator size={20} color={theme.colors.white}></ActivityIndicator> 
                : <Fontisto name="twitch" size={20} color={theme.colors.white} style={{ marginRight: 1 }}></Fontisto>
              }
            </SignInButtonIcon>
